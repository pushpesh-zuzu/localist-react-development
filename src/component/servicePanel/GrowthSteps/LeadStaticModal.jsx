...
const leadData = [
  ...
  { label: "Do you have a preference for the gender of the trainer?", value: "It doesn't matter" },
  { label: "How frequently do you want your sessions?", value: "I'm not sure yet" },
  { label: "How would you describe your current exercise regime?", value: "I am unable due to my knees" },
  ...
  { label: "Do you have any time preference(s)?", value: "Morning (9am-noon), Early afternoon (noon-3pm)" },
];
