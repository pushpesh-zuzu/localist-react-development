...
import styles from "./OTPVerificationNewPPC.module.css";
import {
  createRequestData,
  resendOtp,
  setBuyerStep,
    ...
    <FormWrapper>
      <div className={styles.container}>
        ...
        {/* <h2 className={styles.title}>OTP Verification</h2> */}
         <H3 className={`Inter ${styles.formTitle}`}>OTP Verification</H3>
        {/* <div className={styles.VerifyText}>Please verify your account</div> */}
        <p className={styles.instruction}>
          Enter the OTP sent to{" "}
          <span>{formatUKPhoneNumber(requestUserPhone)}</span>
        </p>
