...
import LandscapingIcon from "../../../assets/ReactIcons/LandscapingIcon";
import GroundWorkIcon from "../../../assets/ReactIcons/GroundWorkIcon";
import SubBaseDrainageIcon from "../../../assets/ReactIcons/SubBaseDrainageIcon";
import MaterialIcon from "../../../assets/ReactIcons/MaterialIcon";
import LabourAndMachineryicon from "../../../assets/ReactIcons/LabourAndMachineryicon";
import WasteRemovalIcon from "../../../assets/ReactIcons/WasteRemovalIcon";
    ...
    <PaddingWrapper className={styles.container}>
      ...
      <div className={styles.features}>
        <div className={styles.featureCard}>
          <LandscapingIcon className={styles.icon} />
        ...
        <div className={styles.featureCard}>
          <GroundWorkIcon className={styles.icon} />
          <H5 className={styles.wordText2}>Groundworks and excavation</H5>
        </div>

        <div className={styles.featureCard}>
          <SubBaseDrainageIcon className={styles.icon} />
        ...
        <div className={styles.featureCard}>
          <MaterialIcon className={styles.icon} />
        ...
        <div className={styles.featureCard}>
          <LabourAndMachineryicon className={styles.icon} />
          <H5 className={styles.wordText5}>
            Labour and machinery
          </H5>
        </div>
        <div className={styles.featureCard}>
          <WasteRemovalIcon className={styles.icon} />
