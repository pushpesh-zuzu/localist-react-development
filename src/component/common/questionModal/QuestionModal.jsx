...
//         dispatch(registerQuoteCustomer(formData)); // save before leaving
//         onClose();
//       }
//     } else {
//       onClose();
...
//       if (buyerRequest?.questions?.length > 0) {
//         // or any unsaved data check
//         e.preventDefault();
//         e.returnValue = ""; // this triggers the confirmation modal
//       }
//     };
...
//     if (!buyerRequest?.questions?.length) return;
...
//     formData.append("city", citySerach);
//     formData.append("postcode", buyerRequest?.postcode);
//     formData.append("form_status", 1); // mark as saved
//     // ...append other params if needed

//     // Use sendBeacon
//     navigator.sendBeacon("/api/register-quote-customer", formData);
//   };
...
//       if (buyerRequest?.questions?.length > 0) {
//         if (window.confirm("You have unsaved data. Leave anyway?")) {
//           saveProgressOnUnload();
//           unblock();
//           tx.retry();
//         }
