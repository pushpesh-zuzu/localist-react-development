  ...
  return (
    <>
      ...
      <SearchAndFindAnAccountant
        ...
        findingHeading={
          HOUSE_EXTENSION_CONFIG_TOP["property-extensions-near-me"]
            ?.findingHeading
        }
        breadcrumb={
        ...
        para1={
          HOUSE_EXTENSION_CONTENT_CONFIG["property-extensions-near-me"]?.para1
        }
        para2={
          HOUSE_EXTENSION_CONTENT_CONFIG["property-extensions-near-me"]?.para2
        }
        para3={
          HOUSE_EXTENSION_CONTENT_CONFIG["property-extensions-near-me"]?.para3
        }
      ...
      <HowItWorks
        HowItWorksData={
          HOUSE_EXTENSION_HOW_IT_WORK["property-extensions-near-me"]
        }
        title={
          HOUSE_EXTENSION_CONFIG_TOP["property-extensions-near-me"]?.ctaText
        }
      />
      <RegionsComponent
      ...
      <FindServiceLevel3
        contentBlocks={
          HOUSE_EXTENSION_FIND_SERVICE_CONTENT["property-extensions-near-me"]
        }
        title={
          HOUSE_EXTENSION_CONFIG_TOP["property-extensions-near-me"]?.ctaText
        }
      />
      <Frequently
        FrequentlyQuestion={HOUSE_EXTENSION_FAQ["property-extensions-near-me"]}
      />
      <AveragePrice
        title={
          HOUSE_EXTENSION_CONFIG_TOP["property-extensions-near-me"]
        ...
        RELTED_PRICE={
          HOUSE_EXTENSION_AVERAGE_PRICE["property-extensions-near-me"]
        }
        // avg_price={HOUSE_EXTENSION_CONFIG_TOP["property-extensions-near-me"]?.showSpeicialits}
        showSpeicialits={
          HOUSE_EXTENSION_CONFIG_TOP["property-extensions-near-me"]
            ?.showSpeicialits
        }
      ...
      <Reviews
        RELATED_REVIEW={
          HOUSE_EXTENSION_REVIEWS_DATA["property-extensions-near-me"]
        }
      />
      <GetQuotesLevel3
        needSString={false}
