        ...
        <>
            <div className="container">
                ...
                <div className={styles.section}>
                    ...
                    <p>Your profile is key to attracting customers on Bark. Use it to explain what makes you different from your competition & why people should work with you</p>
                    <div className={styles.card} style={{ backgroundColor: "#FCE5E3" }}>
                        <h3>Badges</h3>
                    </div>
                    <p>Badges help you stand out. Learn how to use them to boost your business</p>
                    <div className={styles.card} style={{ backgroundColor: "#FCE5E3" }}>
                        <h3>Account details</h3>
                    </div>
                    <p>The email address and password you use to log in, and the phone numbers we use to contact you privately</p>
                </div>
                <div className={styles.section}>
                    <div className={styles.sectionHeader}>
                ...
                <div className={styles.section}>
                    ...
                    <p>Set what type of notifications from us you'd like to receive in your web browser</p>
                </div>
            </div>
        </>
    );
